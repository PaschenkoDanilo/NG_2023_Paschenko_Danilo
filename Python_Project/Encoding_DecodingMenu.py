...
class Window(QMainWindow):
    ...
    def openImage(self):
        self.imageFile = QFileDialog.getOpenFileName(self, "Choosen Image", None, "Image (*.png *.bmp *.jpg *.jpeg)")[0]
    ...
    def startWork(self):
        ...
        if self.comboBox.currentIndex() == 0:
            if self.errors() == 0:
                ...
                self.messageFromOrToUser.setPlainText(encoderMain(self.imageFile, userText))
